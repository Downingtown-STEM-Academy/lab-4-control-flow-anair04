...
let totalPoints = 20
let scoredPoints: Double = Double(questionsCorrect/totalPoints)
if(scoredPoints < 0.7){
    print("You still need to study this more.")
} else if (scoredPoints == 0.7){
    print("You passed, but your should consider studying a bit more")
} else if (scoredPoints > 0.9){
