...
let isRaining = true
let isWindy = false
print("I will go walk for the first set of conditions")
 
/*Set 2
let temp = 82
let isRaining = true
let isWindy = true
print("I will go walk for the second set of conditions")
*/
/* Set 3
let temp = 75
let isRaining = false
let isWindy = true
 print("I will go walk for the third set of conditions")
*/
